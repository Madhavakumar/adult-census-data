...
class DataIngestion:
    ...
    def download_adultcensus_data(self,) -> str:
        try:
            ...
            tgz_file_path = os.path.join(tgz_download_dir, adultcensus_file_name)
    ...
    def extract_tgz_file(self,tgz_file_path:str):
        try:
            ...
            with tarfile.open(tgz_file_path) as adultcensus_tgz_file_obj:
                ...
                safe_extract(adultcensus_tgz_file_obj, path=raw_data_dir)
    ...
    def split_data_as_train_test(self) -> DataIngestionArtifact:
        try:
            ...
            adultcensus_data_frame["income_cat"] = pd.cut(
                adultcensus_data_frame["median_income"],
            ...
            for train_index,test_index in split.split(adultcensus_data_frame, adultcensus_data_frame["income_cat"]):
                strat_train_set = adultcensus_data_frame.loc[train_index].drop(["income_cat"],axis=1)
                strat_test_set = adultcensus_data_frame.loc[test_index].drop(["income_cat"],axis=1)
    ...
    def initiate_data_ingestion(self)-> DataIngestionArtifact:
        try:
            tgz_file_path =  self.download_adultcensus_data()

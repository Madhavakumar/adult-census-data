...
class adultcensusData:
    ...
    def __init__(self,
        ...
        try:
            ...
            self.adultcensus_median_age = adultcensus_median_age
    ...
    def get_adultcensus_data_as_dict(self):
        try:
            input_data = {
                "longitude": [self.longitude],
                "latitude": [self.latitude],
                "adultcensus_median_age": [self.adultcensus_median_age],
